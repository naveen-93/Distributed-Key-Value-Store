...
type RaftClient interface {
	...
	AppendEntries(ctx context.Context, in *EntriesRequest, opts ...grpc.CallOption) (*EntriesResponse, error)
}
...
func (c *raftClient) AppendEntries(ctx context.Context, in *EntriesRequest, opts ...grpc.CallOption) (*EntriesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type RaftServer interface {
	...
	AppendEntries(context.Context, *EntriesRequest) (*EntriesResponse, error)
...
func (UnimplementedRaftServer) AppendEntries(context.Context, *EntriesRequest) (*EntriesResponse, error) {
...
func _Raft_AppendEntries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftServer).AppendEntries(ctx, req.(*EntriesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
